let personas = {
    ...
    "about": "Magna veniam aliquip ex labore anim et commodo nostrud. Ut pariaturmagna magna deserunt. Pariatur nostrud aliqua ad ad consequat. Nisi laborum nostrud essefugiat magna et esse duis commodo. Exercitation pariatur exercitation adipisicing excepteur eu ad. Id dolore sint officia culpa do.\r\n",
    "registered": "2018-07-13T12:09:36 -02:00",
    "latitude": 8.398138,
    "longitude": 145.073922,
    "greeting": "Hello, Melinda Wheeler! You have 9 unread messages.", "favoriteFruit": "banana"
    },
    "Ward Fulton": {
    ...
    "about": "Est ex sunt duis deserunt nisi qui. Cillum veniam dolor do non culpa do eusunt non. Exercitation dolor ex ad nostrud irure anim ex occaecat laborum. Et non pariatur officia non laboris in labore aute. Duis do ad et sit eu ea laborum adipisicing ex nisi consectetur sunt aute reprehenderit.\r\n",
    "registered": "2019-07-29T02:02:08 -02:00",
    "latitude": 5.593906,
    "longitude": -153.125529,
    "greeting": "Hello, Tessa Sellers! You have 6 unread messages.", "favoriteFruit": "strawberry"
    },
    "Kimberley Roberson": {
    ...
    "about": "Irure consequat quis nulla consectetur in magna labore et ad anim duis adoccaecat Lorem. Eiusmod amet exercitation sint non officia do. Cupidatat elit anim mollit id dolor laborum laboris excepteur dolore labore laborum veniam officia.\r\n",
    "registered": "2016-05-26T11:07:07 -02:00",
    "latitude": -75.82921,
    "longitude": 23.130712,
    "greeting": "Hello, Kimberley Roberson! You have 2 unread messages.", "favoriteFruit": "banana"
    },
    "Eleanor Stafford": {
    "_id": "5d8a4813b6a71a7be4cf6a4a",
    "index": 5,
    "guid": "4d540541-746d-4bc2-8718-62d41248015f", "isActive": false,
    "balance": "$3,425.20",
    "picture": "https://randomuser.me/api/portraits/women/30.jpg", "age": 35,
    ...
    "about": "Consequat velit est ut officia ex Lorem. Aliqua veniam sint in amet nisimagna. Ullamco ad laborum exercitation proident exercitation excepteur nulla reprehenderit sunt fugiat nostrud commodo anim ipsum.\r\n",
    "registered": "2019-06-11T07:33:48 -02:00",
    "latitude": -78.220494,
    "longitude": -140.172634,
    "greeting": "Hello, Eleanor Stafford! You have 1 unread messages.", "favoriteFruit": "strawberry"
    },
    "Crane Harris": {
    ...
    "about": "Proident voluptate enim quis non nulla aliquip velit proident mollit. Aliquapariatur id exercitation esse ipsum qui ut eiusmod. Dolor dolor qui do laboris quis est exercitation sit. Eu minim qui commodo qui fugiat occaecat aute. Veniam non do officia sit pariatur tempor sit nulla in magna voluptate mollit ipsum. Dolor et eiusmod aliquip quis deserunt sit officia eu in.\r\n",
    "registered": "2018-08-26T03:15:18 -02:00",
    "latitude": 86.738392,
    "longitude": -72.308621,
    "greeting": "Hello, Crane Harris! You have 1 unread messages.", "favoriteFruit": "strawberry"
    } };

    /*La página tendrá el objeto ‘personas’ en el script. 
    
    Al entrar alguien en la página se le pregunta el nombre de la persona sobre la que se quiere datos. 

    Si coincide el nombre con uno de los 7 en el objeto, mostrar los datos del siguiente modo:
    
    Crea un div centrado tanto vertical como horizontalmente en el que aparecerá la foto de la persona (picture), 
    
    seguida de un h1 con el nombre y párrafos para cada uno de los atributos (age, email y address). 
    
    El color de fondo será el color de ojos (eyeColor). 
    
    En caso de que no haya persona con ese nombre, mostrar un mensaje al respecto. 
    
    El objeto persona a usar es el del archivo Personas.docx.pdf.
    
    Consejo: recordad que hay varias formas de acceder a las claves de los objetos. 
    
    Tendréis que saber cómo buscar dichas claves si no es con la notación de punto, jiji . 
